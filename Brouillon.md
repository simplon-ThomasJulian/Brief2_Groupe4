...
flowchart LR
    ...
    VMAdmin ---|SSH : 10.0.4.1| VN((Virtual Network privé <br /> ETH0))
    VN ---|SSH : 10.0.4.2| BDD[VM BDD Linux <br /> Carte réseau]
    VN ---|SSH : IP 10.0.4.3| Appli[VM Application Linux <br /> Carte réseau]
    end
```
